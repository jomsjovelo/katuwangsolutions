...
export function MessengerWidget() {
  ...
  if (isOverlayActive || isHeroVisible) return null;
  ...
  return (
    <a
      ...
      aria-label="Makipag-chat sa Katuwang Solutions sa Messenger"
      className="fixed bottom-24 right-4 z-50 flex items-center justify-center gap-2 w-12 h-12 sm:w-auto sm:h-auto sm:px-4 sm:py-3 rounded-full text-white shadow-xl hover:scale-105 active:scale-95 transition-all duration-300 motion-reduce:transition-none motion-reduce:transform-none"
      style={{
    ...
    >
      ...
      <span className="hidden sm:inline font-bold tracking-tight text-sm pr-1">Chat with us</span>
    </a>
  );
}
