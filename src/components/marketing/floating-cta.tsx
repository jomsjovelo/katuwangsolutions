...
export function FloatingCta({ onEnterPortal }: FloatingCtaProps) {
  return (
      ...
      <div className="pointer-events-auto bg-white/80 backdrop-blur-xl border-t border-slate-200/60 px-4 pt-3 pb-safe" style={{ paddingBottom: `calc(12px + env(safe-area-inset-bottom, 0px))` }}>
        ...
        >
          <div className="flex flex-col items-start">
            <span className="leading-tight tracking-tight">Magsimula Ngayon</span>
            <span className="text-[10px] text-white/70 font-medium tracking-wide">Walang setup fee · Cancel anytime</span>
          </div>
