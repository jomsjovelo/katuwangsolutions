...
export const MODULE_LANDING_CONTENT: Record<string, ModuleLandingCopy> = {
  ...
  'sahod-flow': {
    headline: 'Sweldo na naman — Iwas-puyat sa kompyutan at bale.',
  ...
  'ledger-flow': {
    headline: 'Alam mo ba kung magkano ang malinis mong kita?',
  ...
  '5-6-tracker': {
    headline: 'Kontrolado ang pautang — Iwas-takbo at atrasado sa singil.',
