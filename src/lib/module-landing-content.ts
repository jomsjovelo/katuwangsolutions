...
export const MODULE_LANDING_CONTENT: Record<string, ModuleLandingCopy> = {
  ...
  'sahod-flow': {
    headline: 'Sweldo na naman — ngayon, walang sakit sa ulo.',
    highlightWord: 'walang sakit sa ulo',
    subtitle: 'Awtomatikong bawas sa bale, 1-tap payout sa staff, at rekta sa ledger ng negosyo. Sweldo na mabilis at walang maling math.',
    tagline: 'Payroll at bale management para sa mga empleyado',
    description: 'Inaayos ng Sahod Flow ang listahan ng empleyado, arawan o lingguhang sweldo, at awtomatikong binabawas ang bale bago ang 1-tap payout.',
  },
  'ledger-flow': {
    headline: 'Alam mo ba kung magkano talaga ang malinis mong pera?',
    highlightWord: 'malinis mong pera',
    subtitle: 'Lahat ng benta sa POS, payroll sa sahod, at pambayad sa suppliers — kusa at awtomatikong dumadaloy sa iisang master ledger.',
    tagline: 'Ang central master cash at expense ledger ng iyong negosyo',
    description: 'Ang Ledger Flow ang puso ng pananalapi ng negosyo. Ang bawat transaksyon mula sa ibang modules ay awtomatikong dumadaloy dito para sa real-time cash balance.',
  },
  '5-6-tracker': {
    headline: 'Kontrolado ang pautang — walang lumalampas sa limit.',
    highlightWord: 'walang lumalampas sa limit',
    subtitle: 'Strict credit limits bawat borrower, araw-araw na singil, at audit trail para protektado ang kapital mo sa bawat koleksyon.',
