...
export const MODULE_LANDING_CONTENT: Record<string, ModuleLandingCopy> = {
  ...
  'sahod-flow': {
    ...
    subtitle: 'Auto-deduct sa vale, 1-tap payout sa staff, at rekta sa ledger ng negosyo. Mabilis magpasahod at walang maling kwenta.',
  ...
  'ledger-flow': {
    headline: 'Alam mo ba kung magkano talaga ang malinis mong kita?',
    highlightWord: 'malinis mong kita',
    subtitle: 'Lahat ng benta sa POS, pasahod sa staff, at bayad sa suppliers — rekta lista sa master ledger para alam mo agad ang totoong pera.',
  ...
  '5-6-tracker': {
    headline: 'Kontrolado ang pautang — iwas-takbo sa utang.',
    highlightWord: 'iwas-takbo sa utang',
    subtitle: 'May credit limit bawat borrower, araw-araw na talaan ng singil, at kumpletong audit trail para ligtas ang kapital mo araw-araw.',
